    ...
    return (
        <div className="creacod-app">
            <header className="creacod-app__header">
                ...
                <h1>Stap 3</h1>
                <p>
                    Er is een bericht verborgen in de lagen van deze figma bestanden.
                </p>
            </header>
            ...
            <div className="creacod-app__body">
                <section className="creacod-app__panel">
                    <h2>Wat is Figma?</h2>
                    <p>
                        Figma is een programma waarmee je een ontwerp kunt tekenen
                        op je computer of online.
                    </p>
                    <p>
                ...
                <section className="creacod-app__panel">
                    ...
                    <p>
                        ...
                        Figma. Vind de verborgen boodschap in de lagen van de bestanden.
                    </p>
